...
-keep class com.Go23WalletManage { *; }
-keep class com.coinsapp.callback.** { *; }
-keep class com.coinsapp.track.** { *; }
-keep class com.go23.bean.** { *; }
-keep class com.go23.callback.** { *; }
-keep class com.go23.enumclass.** { *; }
-keep class com.go23.util.** { *; }
