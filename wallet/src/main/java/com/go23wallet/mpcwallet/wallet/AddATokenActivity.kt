...
import com.go23wallet.mpcwallet.adapter.AddTokenListAdapter
import com.go23wallet.mpcwallet.base.BaseActivity
import com.go23wallet.mpcwallet.databinding.ActivityAddATokenBinding
import com.go23wallet.mpcwallet.livedata.TokenListLiveData
...
class AddATokenActivity : BaseActivity<ActivityAddATokenBinding>() {
    ...
    private var mAdapter: com.go23wallet.mpcwallet.adapter.AddTokenListAdapter? = null
    ...
    private fun initView() {
        binding.recyclerView.apply {
            ...
            if (mAdapter == null) {
                mAdapter =
                    com.go23wallet.mpcwallet.adapter.AddTokenListAdapter(this@AddATokenActivity)
            }
            adapter = mAdapter
        }
    }
